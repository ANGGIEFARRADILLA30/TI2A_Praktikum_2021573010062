...
$query = mysqli_query($conn, "SELECT *FROM daftar_menu LEFT JOIN kategori_menu ON kategori_menu.id_katmenu = daftar_menu.kategori");
while ($record = mysqli_fetch_array($query)) {
    $result[] = $record;
}

$select_kat_menu = mysqli_query($conn, "SELECT id_katmenu,kategori_menu FROM kategori_menu");
?>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col d-flex justify-content-end">
                    <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#ModalTambahUser">Tambah Menu</button>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_menu.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-info" name="input_menu_validate" value="12345">Save changes</button>
                                </div>
                        </div>
